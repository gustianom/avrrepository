...
/**
 * Created by Andrian on 10/07/15  11:09
 * CR by ndwijaya on 19/08/15
 */
public abstract class CourseCustomModify extends TenmaMasterFormModify {
    ...
    public CourseCustomModify(TenmaPanel parentContainer, int modifyMode) {
