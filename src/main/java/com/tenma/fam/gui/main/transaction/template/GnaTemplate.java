 ...
 * Created on 29/10/15.
 */
public class GnaTemplate extends VerticalLayout {
    ...
    private List<TransactionTemplateModel> loadingTemplate() {
        ...
        map.put("type", Constants.TEMPLATE_TYPE.GNA.getValue());
    ...
    private MouseEvents.ClickListener createListener() {
        MouseEvents.ClickListener lst = new MouseEvents.ClickListener() {
            ...
            public void click(MouseEvents.ClickEvent event) {
                ...
                System.out.println("Gna --> item.getModel().getTemplateName() = " + item.getModel().getTemplateName());
